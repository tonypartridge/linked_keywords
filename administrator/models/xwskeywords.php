...
/**
 * Methods supporting a list of Xws_linked_keywords records.
 *
 * @since  1.6
 */
class Xws_linked_keywordsModelXwskeywords extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_xws_linked_keywords');
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__xws_linked_keywords` AS a');
		...
		foreach ($items as $oneItem) {
			...
			if ( isset($oneItem->menuitem) ) {
				...
				// Get the title of that particular menu
					$title = Xws_linked_keywordsHelper::getMenuItemNameByMenuItemId($oneItem->menuitem);

					// Finally replace the data object with proper information
					$oneItem->menuitem = !empty($title) ? $title : $oneItem->menuitem;
				}
		}
		return $items;
	}
